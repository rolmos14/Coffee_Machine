class ComplexNumber:
    ...
    def __truediv__(self, other):
        reciprocal_real = other.real_part / (other.real_part ** 2 + other.im_part ** 2)
        reciprocal_imaginary = - other.im_part / (other.real_part ** 2 + other.im_part ** 2)
        return self.__mul__(ComplexNumber(reciprocal_real, reciprocal_imaginary))
